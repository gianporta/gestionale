...
use App\Filament\Resources\StatePaymentResource\Pages;
...
class StatePaymentResource extends Resource
{
    ...
    {
        $columns = DBHelper::getTableColumns((new StatePayment())->getTable());
