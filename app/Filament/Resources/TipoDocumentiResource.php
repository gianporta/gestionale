...
use App\Filament\Resources\TipoDocumentiResource\Pages;
use App\Helpers\DBHelper;
use App\Helpers\FormHelper;
use App\Helpers\TableHelper;
use App\Models\TipoDocumenti;
...
class TipoDocumentiResource extends Resource
{
    ...
    {
        $columns = DBHelper::getTableColumns((new TipoDocumenti())->getTable());
